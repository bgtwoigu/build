...
LLVM_DEVTOOLS_VERSION := 3.5
LLVM_DEVTOOLS_PATH := devtools/clang/$(BUILD_OS)-x86/host/$(LLVM_DEVTOOLS_VERSION)/bin

CLANG := $(LLVM_DEVTOOLS_PATH)/clang$(BUILD_EXECUTABLE_SUFFIX)
CLANG_CXX := $(LLVM_DEVTOOLS_PATH)/clang++$(BUILD_EXECUTABLE_SUFFIX)
LLVM_AS := $(LLVM_DEVTOOLS_PATH)/llvm-as$(BUILD_EXECUTABLE_SUFFIX)
LLVM_LINK := $(LLVM_DEVTOOLS_PATH)/llvm-link$(BUILD_EXECUTABLE_SUFFIX)
