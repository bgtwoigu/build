...
TARGET_GNUEABI_PATH := $(TARGET_GCC_PATH)/$(TARGET_LINUX_EABI_PREFIX)-$(TARGET_GCC_VERSION)
TARGET_GNUEABI_LIBC_PATH := $(TARGET_GNUEABI_PATH)/$(TARGET_LINUX_EABI_PREFIX)/libc
TARGET_GNUEABI_BIN_PATH := $(TARGET_GNUEABI_PATH)/$(TARGET_LINUX_EABI_PREFIX)/bin
